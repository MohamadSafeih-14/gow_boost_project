...
import { sendReport } from 'src/lib/actions/customer_dashboard.actions';
import { toast } from 'react-toastify';
import { useRouter } from 'next/navigation';
interface Props {}

const ReportCmp = ({role}: {role: string}) => {
  ...
  return (
    <>
      <p className='pl-4 text-center'>If you encounter any bugs with the website, feel free to <button onClick={onOpen} className='text-[#D19638]'>Report</button> them to us</p>
      <Modal 
        isOpen={isOpen} 
