...
const page = () => {
  return (
    <section>
    <div className='empty'>
    <div className='terms-container pb-[100px]'>
      <h1 className='text-3xl mt-[100px]'>Privacy Policy</h1>
      <p>
      ...
      mobile application&#39; push notifications regarding updates or informative communications related to the functionalities, products
      ...
      <a href='mailto:gowboostinglol@gmail.com'>
        gowboostinglol@gmail.com
      </a>
      <a target='_blank' href='https://discord.gg/KwuUsyEEQb'>
        Join Discord
      </a>
